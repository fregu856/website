...
Among the 113 papers, here are 25 that I found particularly interesting and/or well written (in alphabetical order):

* [Adaptable Cardiovascular Disease Risk Prediction from Heterogeneous Data using Large Language Models](https://arxiv.org/abs/2505.24655) (arxiv, 2025-05)
* [Artificial Intelligence for Hemodynamic Monitoring With a Wearable Electrocardiogram Monitor](https://www.nature.com/articles/s43856-024-00730-5) (Communications Medicine, 2025)
* [BenchECG and xECG: A Benchmark and Baseline for ECG Foundation Models](https://arxiv.org/abs/2509.10151) (arxiv, 2025-09)
* [Beyond Sensor Data: Foundation Models of Behavioral Data from Wearables Improve Health Predictions](https://arxiv.org/abs/2507.00191) (ICML 2025)
* [BLIP-2: Bootstrapping Language-Image Pre-training with Frozen Image Encoders and Large Language Models](https://proceedings.mlr.press/v202/li23q/li23q.pdf) (ICML 2023)
* [Bootstrap Your Own Latent: A New Approach to Self-Supervised Learning](https://arxiv.org/abs/2006.07733) (NeurIPS 2020)
* [Development and Validation of an Autonomous Artificial Intelligence Agent for Clinical Decision-Making in Oncology](https://www.nature.com/articles/s43018-025-00991-6) (Nature Cancer, 2025)
* [Digital Profiling of Gene Expression from Histology Images with Linearized Attention](https://www.nature.com/articles/s41467-024-54182-5) (Nature Communications, 2024)
* [ECG Semantic Integrator (ESI): A Foundation ECG Model Pretrained with LLM-Enhanced Cardiological Text](https://openreview.net/forum?id=giEbq8Khcf) (TMLR, 2024)
* [Emerging Properties in Self-Supervised Vision Transformers](https://openaccess.thecvf.com/content/ICCV2021/html/Caron_Emerging_Properties_in_Self-Supervised_Vision_Transformers_ICCV_2021_paper.html) (ICCV 2021)
* [Foundation Model of Electronic Medical Records for Adaptive Risk Estimation](https://arxiv.org/abs/2502.06124) (GigaScience, 2025)
* [HEST-1k: A Dataset for Spatial Transcriptomics and Histology Image Analysis](https://arxiv.org/abs/2406.16192) (NeurIPS 2024)
* [iBOT: Image BERT Pre-Training with Online Tokenizer](https://arxiv.org/abs/2111.07832) (ICLR 2022)
* [LabTOP: A Unified Model for Lab Test Outcome Prediction on Electronic Health Records](https://arxiv.org/abs/2502.14259) (CHIL 2025)
* [Large Language Models are Powerful Electronic Health Record Encoders](https://arxiv.org/abs/2502.17403) (arxiv, 2025-02)
* [MedRAX: Medical Reasoning Agent for Chest X-ray](https://arxiv.org/abs/2502.02673) (ICML 2025)
* [Muddit: Liberating Generation Beyond Text-to-Image with a Unified Discrete Diffusion Model](https://arxiv.org/abs/2505.23606) (arxiv, 2025-05)
* [OneCAT: Decoder-Only Auto-Regressive Model for Unified Understanding and Generation](https://arxiv.org/abs/2509.03498) (arxiv, 2025-09)
* [Path2Space: An AI Approach for Cancer Biomarker Discovery Via Histopathology Inferred Spatial Transcriptomics](https://www.biorxiv.org/content/10.1101/2024.10.16.618609v1) (biorxiv, 2024-10)
* [Performance Prediction for Large Systems via Text-to-Text Regression](https://arxiv.org/abs/2506.21718) (arxiv, 2025-06)
* [Q-Heart: ECG Question Answering via Knowledge-Informed Multimodal LLMs](https://arxiv.org/abs/2505.06296) (arxiv, 2025-05)
...
* [SensorLM: Learning the Language of Wearable Sensors](https://arxiv.org/abs/2506.09108) (NeurIPS 2025)
...
* [Invandrarna](https://www.goodreads.com/book/show/17189707-invandrarna) | _**Vilhelm Moberg**_ | Rating: 4
* [Jävla karlar](https://www.goodreads.com/book/show/195857823-j-vla-karlar) | _**Andrev Walden**_ | Rating: 4
* [Köpenhamnstriologin](https://www.goodreads.com/book/show/53317528-the-copenhagen-trilogy) | _**Tove Ditlevsen**_ | Rating: 4.5
* [Minns du den stad](https://www.goodreads.com/book/show/1696122.Minns_du_den_stad) | _**Per Anders Fogelström**_ | Rating: 4.5
* [Stacken](https://www.goodreads.com/book/show/194021202-stacken) | _**Annika Norlin**_ | Rating: 4
